 ...
 */
    [_QWERTY] = LAYOUT(
     ...
     _______ ,   SE_Z ,  SE_X  ,  SE_C  ,   SE_V ,   SE_B , SE_LBRC,                   SE_RBRC,    SE_N,   SE_M , SE_COMM, SE_DOT , SE_SLSH, _______,
                                _______ , TD_CPS , NAV_ENT, NUMBAR , _______, _______,  KC_SPC,     SYM, KEY_OVERRIDE_TOGGLE, _______
    ),
/*
 ...
 */
    [_NAV] = LAYOUT(
      ...
      _______,  KC_F1 ,  KC_F2 ,  KC_F3 ,  KC_F4 , _______, _______,                   _______,KC_PAUSE, KC_MPRV, KC_MPLY, KC_MNXT, KC_MUTE, KC_PSCR,
 ...
 */
    [_NUMBAR] = LAYOUT(
      ...
      _______, _______, _______, _______, _______, _______, _______,                   _______, _______, SE_1,    SE_2,    SE_3, SE_SLSH, _______,
