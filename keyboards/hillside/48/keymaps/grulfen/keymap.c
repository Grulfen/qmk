 ...
 */
    [_ADJUST] = LAYOUT(
      _______, QWERTY , UG_HUEU, UG_SATU, UG_VALU, UG_SPDU,                                     _______, _______, _______, _______, _______, _______,
      _______, MAC_QWE, UG_HUED, UG_SATD, UG_VALD, UG_SPDD,                                     _______, _______, _______, _______, _______, _______,
      _______, _______, UG_TOGG, _______, UG_PREV, UG_NEXT, _______,                   _______, _______, _______, _______, _______, _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
